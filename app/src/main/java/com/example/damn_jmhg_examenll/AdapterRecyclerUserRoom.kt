...
class AdapterRecyclerUserRoom(var users: List<User>): RecyclerView.Adapter<AdapterRecyclerUserRoom.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvCompany.text = "${users[position].company.nameCompany}, ${users[position].company.catchPhrase}, ${users[position].company.bs}"
    }
